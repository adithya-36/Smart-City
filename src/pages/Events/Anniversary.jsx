...
import Image1 from '../../assets/images/anniversary/punarjani.jpg';
import Image2 from '../../assets/images/anniversary/poster1.jpg';
import Image3 from '../../assets/images/anniversary/poster2.jpg';
import Image4 from '../../assets/images/anniversary/poster3.jpg';
import Image5 from '../../assets/images/anniversary/poster4.jpg';
import Image6 from '../../assets/images/anniversary/poster5.jpg';
...
const Anniversary = () => {
  ...
  const images = [
    { id: 1, src: Image1, alt: "Punarjani Celebration"},
    { id: 2, src: Image2, alt: "Anniversary Poster 1"},
    { id: 3, src: Image3, alt: "Anniversary Poster 2"},
    { id: 4, src: Image4, alt: "Anniversary Poster 3"},
    { id: 5, src: Image5, alt: "Anniversary Poster 4"},
    { id: 6, src: Image6, alt: "Anniversary Poster 5"},
    { id: 7, src: Image7, alt: "Anniversary Poster 6"},
    { id: 8, src: Image8, alt: "Anniversary Poster 7", title: "" },
    { id: 9, src: Image9, alt: "Anniversary Poster 8"}
  ];
          ...
          >
            ...
            <div className="bg-white  overflow-hidden shadow-2xl">
              ...
              <div className="p-4 bg-[#184E77] text-white">
                <p className="text-sm opacity-90">8th Anniversary Celebration</p>
              </div>
            </div>
          </div>
        </div>
