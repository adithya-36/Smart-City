    ...
    <div className="bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mb-16">
          ...
          {/* Poster Section */}
          <div className="bg-white shadow-md p-6 max-w-2xl mx-auto border-t-4 border-[#1A759F]">
            <h2 className="text-xl font-bold mb-4 text-center text-[#1E6091]">
              Event Poster
            </h2>
            <img
              src={Poster}
                ...
                <div className="p-5">
                  <div className="flex justify-center -mt-16">
                    <div className="relative">
                      ...
                      />
                      <div
                        className="absolute bottom-0 right-0 w-8 h-8 flex items-center justify-center text-white bg-[#1E6091]"
                      >
                        {index + 1}
                      </div>
                    </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex items-start">
                    <div
                      className="flex-shrink-0 w-8 h-8 flex items-center justify-center text-white mr-3 mt-1 bg-[#1E6091]"
                    >
                      {item.step}
                    </div>
                ...
                <div className="mt-8 text-center">
                  <a href="https://internship.aicte-india.org/"
                    ...
                    <button
                      className="py-3 px-8 bg-[#1E6091] hover:bg-[#184E77] text-white font-bold shadow-sm hover:shadow-md transition duration-300"
                    >
